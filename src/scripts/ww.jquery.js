...
*/(function ($, undefined) {
    ...
    $.modalDialog = function (msg, header, aButtons, handler, isHtml) {
        ...
        dl.modalDialog({ dialogHandler: handler, headerId: "_MBOXHEADER", contentId: "_MBOXCONTENT" }, msg, header, isHtml).draggable({ handle: $("#_MBOX .dialog-header") }).closable({
